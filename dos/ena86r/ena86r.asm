...
;
; File Name   :	C:\ENA86R\ENA86R.COM
; Format      :	MS-DOS COM-file
; Base Address:	1000h Range: 10100h-104F5h Loaded length: 3F5h
...
loc_10115:				; CODE XREF: start+10j
		...
		mov	dx, 3E1h
		out	dx, al
		mov	ax, 0B01h	; reg B	val 01
					; io window 0 ends at 18Fh
		xchg	ah, al
		mov	dx, 3E0h
		or	al, cs:regOffset
		out	dx, al
...
loc_10407:				; CODE XREF: sub_10403+27j
		mov	cl, [si]
		cmp	cl, 30h	; '0'
		jb	loc_10450
		cmp	cl, 39h	; '9'
...
loc_10416:				; CODE XREF: sub_10403+3Ej
		cmp	ax, 1000h
		jnb	loc_10443
		shl	ax, 1
		shl	ax, 1
...
loc_1042C:				; CODE XREF: sub_10403+Ej
		mov	cl, [si]
		sub	cl, 41h	; 'A'
		cmp	cl, 5
		jbe	loc_10439
...
loc_10439:				; CODE XREF: sub_10403+31j
		cmp	cl, 5
		ja	loc_10450
		add	cl, 0Ah
		jmp	short loc_10416
...
loc_10443:				; CODE XREF: sub_10403+16j
					; sub_10403+25j
		mov	ax, 0FFFFh
		stc
		pop	si
...
loc_1044A:				; CODE XREF: sub_10403+50j
		mov	ax, 0
		stc
		jmp	short loc_10456
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_10450:				; CODE XREF: sub_10403+9j
					; sub_10403+39j
		pop	cx
		cmp	si, cx
		jz	loc_1044A
...
loc_10456:				; CODE XREF: sub_10403+45j
					; sub_10403+4Bj
		pop	cx
		retn
sub_10403	endp
...
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
aEna86rCard86R9	db 'ENA86R - Card86-R/98 Enabler  Version 1.11',0Dh,0Ah ; DATA XREF: starto
		db 'Copyright (C) 1999-2002 By XEXYZA_7773',0Dh,0Ah,'$'
a___enabled	db '...Enabled!',0Dh,0Ah,'$' ; DATA XREF: start+22Co
aUsageEna86rSxX	db 0Dh,0Ah		; DATA XREF: seg000:0346o
		db 'Usage: ENA86R [/Sx]     x=Socket(0-3)',0Dh,0Ah,'$'
